...
<head>
  ...
  <style>
    ...
    .event-title { font-family: var(--font-hero); font-size: clamp(3rem, 6vw, 5.5rem); line-height: 1; margin-bottom: 1.5rem; color: var(--text-dark); letter-spacing: -2px;}
...
<body>
  ...
  <main>
    <section class="event-hero">
      ...
      <div class="container hero-content" style="max-width: 900px; position:relative; z-index:2;">
    ...
    <section class="section-spacing container">
      ...
      <div class="split-content reverse reveal-stagger">
        ...
        <div class="split-text">
          <h2 class="split-title">What You <br><span style="color: __THEME_COLOR__">Will Experience</span></h2>
...
const events = [
    {
        ...
        subtitle: 'A powerful workshop day designed to help you identify and reprogramme internal patterns.',
        date: 'June 14th 2026',
        location: 'Hebden Bridge, UK',
        type: 'Transformational Workshop',
    ...
    },
    {
        ...
        conclusion: 'Bring your family to nature.',
        button: 'Join the Gathering'
    },
    {
        fileName: 'event-renewal.html',
        title: 'Renewal & Rebirth',
        ...
        conclusion: 'Prepare for your journey.',
        button: 'Reserve Your Place'
    },
    {
        fileName: 'event-dance.html',
        title: 'Dance with the Divine Feminine',
        subtitle: 'An immersive retreat experience dedicated to awakening and embodying feminine energy.',
        date: 'July 2027',
        location: 'Spain',
        type: 'Embodiment Retreat',
        ...
        conclusion: 'Awaken your inner rhythm.',
        button: 'Reserve Your Place'
    },
    {
        ...
        conclusion: 'Discover the magic of the outdoors.',
        button: 'Join the Gathering'
    }
];
